    ...
    <div className="flex  gap-10 my-12 ">
      ...
      <div className="">
        ...
        <div className="flex items-center gap-5 my-4">
          <div
            onClick={addBasket}
            className="my-4 border w-[200px] text-2xl rounded-md bg-gray-300 cursor-pointer h-16 flex items-center justify-center"
          >
            Sepete Ekle
          </div>
          ...
          <input
            className="w-7 text-center text-2xl font-bold"
            type="text"
            value={quantity}
          />
